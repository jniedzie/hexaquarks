...
void HistogramSet::fill(const Particle* particle_1, const Particle* particle_2, const Particle* particle_3)
{    
  TLorentzVector triparticle = particle_1->four_vector + particle_2->four_vector + particle_3->four_vector;
  hists["pt"]->Fill(triparticle.Pt());
  hists["mass"]->Fill(triparticle.M());
  hists["mass_log"]->Fill(triparticle.M());
  hists["eta"]->Fill(triparticle.Eta());
  hists["phi"]->Fill(triparticle.Phi());
}
